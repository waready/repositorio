...
Vue.component('CreateComponent', require('./components/CreateComponent.vue').default);
Vue.component('cip-constancia', require('./components/cip-constancia.vue').default);
