	...
	<body>
		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
                    <span> <a href="{{ route('logout') }}" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser" onclick="event.preventDefault();
		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					<li class="">
						<a href="index" title="blank_"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Blank</span></a>
					</li>
				</ul>
			</nav>
		...
		<div id="shortcut">
			<ul>
				<li>
					<a href="index" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-envelope fa-4x"></i> <span>Mail <span class="label pull-right bg-color-darken">14</span></span> </span> </a>
				</li>
			</ul>
		</div>
		<!-- END SHORTCUT AREA -->
		...
		<!-- PACE LOADER - turn this on if you want ajax loading to show (caution: uses lots of memory on iDevices)-->
		<script data-pace-options='{ "minTime": 5000 }' src="js/plugin/pace/pace.min.js"></script>
