...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Cumpleaños | Colegiados </title>
        ...
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                rowCallback: function( row, data, index ) {
                    ...
                    if(data.tipoColegiado  == 0){
                        $('td:eq(7)', row).html('FALLECIDO');
                    }
                    if(data.tipoColegiado  == 1){
                        $('td:eq(7)', row).html('INCORPORADO');
                    }
                    if(data.tipoColegiado  == 2){
                        $('td:eq(7)', row).html('TRANSFERIDO NACIONAL');
                    }
                    if(data.tipoColegiado  == 3){
                        $('td:eq(7)', row).html('VITALICIO');
                    }
                    if(data.tipoColegiado  == 4){
                        $('td:eq(7)', row).html('TEMPORAL');
                    }
                    if(data.tipoColegiado  == 5){
                        $('td:eq(7)', row).html('EN TRAMITE');
                    }
                    if(data.tipoColegiado  == 6){
                        $('td:eq(7)', row).html('NACIONAL');
                    }
                    if(data.tipoColegiado  == 7){
                        $('td:eq(7)', row).html('INCORPORADO NACIONAL');
                    }
                    if(data.estadoUsuario  == 10){
                        $('td:eq(8)', row).html('Habil');
                    }
                    if(data.estadoUsuario  == 11){
                        $('td:eq(8)', row).html('No Habil');
                    }
                }
