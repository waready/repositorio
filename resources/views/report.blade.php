                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="ajax-load text-center" style="display:none">
                                        <p><img src="{{asset('img/ajax-loader.gif')}}" alt=""> Cargando...</p>
                                    </div>
                                </div>
                            </div>
...
<![endif]-->
        ...
        <script>
           function loadMoreData(page)
           {
               ...
               .done(function(data){
                   if(data.html == ""){
                       $('.ajax-load').html("no more recods found");
                   }
                   $('.ajax-load').hide();
                   $("#post-data").append(data.html);
                   //({ scrollTop: $(this).prop("scrollHeight")}, 1000);

                   
               })
               .fail(function(jqXHR,ajaxOptions,thrownError){
                alert("server fails no responde");
               });
           }
