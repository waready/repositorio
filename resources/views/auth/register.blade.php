...
<div id="main" role="main">
    ...
    <div id="content" class="container">
            <ul class="header-dropdown-list hidden-xs">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Idioma  <img src="img/blank.gif" class="flag flag-us" alt="United States"> <span> US</span> <i class="fa fa-angle-down"></i> </a>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
                <h1 class="txt-color-red login-header-big">Colegio de Ingenieros cede Puno</h1>
                <div class="hero">

                    <div class="pull-left login-desc-box-l">
                        <h4 class="paragraph-header">
                            Sistema de Administracion y Control de Colegidos cede Puno.
                        </h4>
                        <div class="login-app-icons">
                            <a href="javascript:void(0);" class="btn btn-danger btn-sm">Nuestra Pagina web</a>
                            <a href="javascript:void(0);" class="btn btn-danger btn-sm">Mas informacion</a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <h5 class="about-heading">Acerca de la aplicacion</h5>
                        <p>
                            Es una actualizacion del sistemas de Administracion de colegiados con una mejora en tema de corbanzas y manejo de usuarios.
                        </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <h5 class="about-heading">Experencia de uso!</h5>
                        <p>
                            el manejo es muy censillo e intuitivo, con colores agradables y vistas amigables que te ayduaran a un mejor uso de la aplicacion.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div class="well no-padding">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="smart-form client-form">
                        @csrf
                        <header>
                            {{ __('Register') }}
                        </header>
